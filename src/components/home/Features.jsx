import { ChartBar, Check, ListCheck, SlidersHorizontal } from 'lucide-react';
                ...
                <div className="grid items-center gap-12 lg:grid-cols-2">
                    <div className="lg:col-span-1 lg:order-2">
                        <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center text-blue-600 text-xl mb-6">
                            <ListCheck size={22} strokeWidth={3} />
                        </div>
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-center text-slate-700">
                                <Check size={18} strokeWidth={3} className="text-blue-600 mr-3" /> Массовый парсинг каталогов и товаров
                            </li>
                            <li className="flex items-center text-slate-700">
                                <Check size={18} strokeWidth={3} className="text-blue-600 mr-3" /> Выгрузка всех вариантов одной карточки
                            </li>
                        </ul>
                    </div>
                ...
                <div className="grid items-center gap-12 lg:grid-cols-2">
                    <div className="lg:col-span-1">
                        ...
                        <ul className="space-y-3 mb-8">
                            <li className="flex items-center text-slate-700">
                                <Check size={18} strokeWidth={3} className="text-blue-600 mr-3" /> Мгновенный поиск по всей таблице
                            </li>
                            <li className="flex items-center text-slate-700">
                                <Check size={18} strokeWidth={3} className="text-blue-600 mr-3" /> Умная сортировка данных
                            </li>
                            <li className="flex items-center text-slate-700">
                                <Check size={18} strokeWidth={3} className="text-blue-600 mr-3" /> Экспорт в Excel (XLSX), CSV и JSON в один клик
                            </li>
                        </ul>
                    </div>
                    <div className="lg:col-span-1">
                ...
                <div className="grid items-center gap-12 lg:grid-cols-2">
                    <div className="lg:col-span-1 lg:order-2">
                        ...
                        <div className="bg-slate-50 border border-slate-100 p-4 rounded-lg mb-6">
                            <p className="font-semibold text-slate-900 mb-2 text-sm">Пример</p>
                            <p className="text-sm text-slate-700">Вам нужно поле <strong>&ldquo;Объём&rdquo;</strong>? Просто укажите это название в настройках, и оно появится в вашей таблице.</p>
                        </div>
                    </div>
                    <div className="lg:col-span-1 lg:order-1">
                        <Video
